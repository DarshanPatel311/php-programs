        ...
        <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-center mb-4">Add New Phone</h3>
                        <form method="POST" action="">
                            ...
                            <div class="mb-3">
                                <label for="category" class="form-label">Modal</label>
                                <input id="category" class="form-control" name="category" type="text"
                                    placeholder="Modal" required>
                            </div>

                            <div class="row">
                                <div class="col text-center">
                                    <button name="submit" class="btn btn-primary">Submit</button>
                                    <button name="show" onclick="location.href='products.php'" class="btn btn-secondary">Show Data</button>
                                </div>
                            </div>
